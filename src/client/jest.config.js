...
module.exports = {
    ...
    globals: {
        ...
        __CLIENT__: true,
        __SERVER__: false,
        __RUN_LOCALLY__: process.env['RUN_LOCALLY'] === 'true',
        __PROD__: process.env['NODE_ENV'] === 'production',
        __DEV__: process.env['NODE_ENV'] === 'development' || process.env['NODE_ENV'] === undefined,
    },
    ...
    transform: {
        '^.+\\.(js|jsx|ts|tsx)$': '<rootDir>/jest/browserTransformer.js',
    },
